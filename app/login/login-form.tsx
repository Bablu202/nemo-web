...
export const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmitHandler)}>
      ...
      <button
        type="submit"
        style={{ backgroundColor: isPending ? "#ccc" : "#24386E" }}
        className="inline-block px-7 py-4 bg-custom-pri text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full"
        disabled={isPending}
      >
