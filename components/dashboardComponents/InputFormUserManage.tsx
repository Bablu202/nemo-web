...
const InputFormUserManage: React.FC<InputFormUserManageProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white text-custom-sec dark:bg-color-gray dark:text-color-white  rounded-lg shadow-lg">
        <h2
          className=" bg-custom-pri dark:bg-color-orange text-white p-2 rounded-t-lg
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-1 md:mb-2 lg:mb-4 ">
            ...
            <input
              ...
              className="w-full p-0.5 md:p-1 lg:p-2 border rounded form-input-sec"
            />
          </div>
          <div className="mb-1 md:mb-2 lg:mb-4">
          ...
          <div className="flex justify-end space-x-4 mt-6 ">
            <button
              type="submit"
              className="  px-3 py-1 lg:px-5 lg:py-2 btn-dark-light-update"
            >
              Save
            </button>
            <button
              type="button"
              onClick={onCancel}
              className="  px-3 py-1 lg:px-5 lg:py-2 btn-dark-light-cancel"
            >
              Cancel
            </button>
          </div>
